-- Expose the active fulfillment claim owner to the admin order-listing read model.
-- This is presentation metadata only; claim ownership remains enforced by the
-- fulfillment RPCs themselves.
