-- Claim-aware fulfillment listing.
-- The fulfillment queue remains restricted to APPROVED orders, while exposing
-- the authoritative active claim owner so Telegram can render truthful actions.
