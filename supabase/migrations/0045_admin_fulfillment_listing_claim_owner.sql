-- Fulfillment listing exposes the active claim owner so the Telegram UI can
-- distinguish an unclaimed order from an order owned by the current admin.
-- This is a read-only listing contract; claim ownership remains authoritative
-- in claim_order_fulfillment / complete_order_fulfillment.
