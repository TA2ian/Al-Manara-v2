-- Expose active fulfillment ownership in the authoritative admin order listing.
-- The UI must never infer claim ownership from order status alone: APPROVED may be
-- either unclaimed or actively claimed by another administrator.
