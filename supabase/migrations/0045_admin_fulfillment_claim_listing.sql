-- Expose the active fulfillment claim owner in the authoritative admin order listing.
-- The UI must never advertise completion unless the current admin owns the claim.
