...
insert into wallets (
  ...
  ('00000000-0000-0000-0000-000000002211','00000000-0000-0000-0000-000000002201','BEP20','0x0000000000000000000000000000000000002201','0x0000000000000000000000000000000000002201','VERIFIED','six-network test'),
  ('00000000-0000-0000-0000-000000002212','00000000-0000-0000-0000-000000002202','TRC20','T9yD14Nj9j7xAB4dbGeiX9h8unkM4Jx7nQ','T9yD14Nj9j7xAB4dbGeiX9h8unkM4Jx7nQ','VERIFIED','six-network test'),
  ('00000000-0000-0000-0000-000000002213','00000000-0000-0000-0000-000000002203','ARB','0x0000000000000000000000000000000000002203','0x0000000000000000000000000000000000002203','VERIFIED','six-network test'),
  ('00000000-0000-0000-0000-000000002214','00000000-0000-0000-0000-000000002204','ETH','0x0000000000000000000000000000000000002204','0x0000000000000000000000000000000000002204','VERIFIED','six-network test'),
  ('00000000-0000-0000-0000-000000002215','00000000-0000-0000-0000-000000002205','SOL','11111111111111111111111111111111','11111111111111111111111111111111','VERIFIED','six-network test'),
  ('00000000-0000-0000-0000-000000002216','00000000-0000-0000-0000-000000002206','POLYGON','0x0000000000000000000000000000000000002206','0x0000000000000000000000000000000000002206','VERIFIED','six-network test');
...
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002221', 1, 22001001, 'primary', 'complete-2201', '00000000-0000-0000-0000-000000002231', repeat('a',64))$$, 'BEP20 completion succeeds');
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002222', 1, 22001001, 'primary', 'complete-2202', '00000000-0000-0000-0000-000000002231', repeat('b',64))$$, 'TRC20 completion succeeds');
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002223', 1, 22001001, 'primary', 'complete-2203', '00000000-0000-0000-0000-000000002231', repeat('c',64))$$, 'ARB completion succeeds');
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002224', 1, 22001001, 'primary', 'complete-2204', '00000000-0000-0000-0000-000000002231', repeat('d',64))$$, 'ETH completion succeeds');
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002225', 1, 22001001, 'primary', 'complete-2205', '00000000-0000-0000-0000-000000002231', repeat('e',64))$$, 'SOL completion succeeds');
select lives_ok($$select * from complete_order_fulfillment('00000000-0000-0000-0000-000000002226', 1, 22001001, 'primary', 'complete-2206', '00000000-0000-0000-0000-000000002231', repeat('f',64))$$, 'POLYGON completion succeeds');
