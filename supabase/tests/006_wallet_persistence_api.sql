...
select is((select wallet_id from find_verified_wallet_by_address(' 0x2222222222222222222222222222222222222222 ', 'BEP20')), '00000000-0000-0000-0000-000000009912'::uuid, 'verified wallet can be found by normalized text on the requested network');
select is((select wallet_id from find_verified_wallet_by_address(' 0x2222222222222222222222222222222222222222 ', 'ETH')), null::uuid, 'same address is not treated as a duplicate across networks');
