...
def build_admin_composition(client: Any, order_uow: UnitOfWork | None = None, *, emergency_mode: bool = False) -> AdminComposition:
    ...
    return AdminComposition(
        review=TelegramAdminOrderReviewHandler(review_service, authorization, authorization, confirmation_service),
        ...
        recovery=TelegramAdminReceiptReopenHandler(recovery_service, authorization, confirmation_service),
